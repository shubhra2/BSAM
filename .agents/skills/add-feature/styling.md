...
- External library guides can be found here: https://github.com/wasp-lang/wasp/tree/release/web/docs/guides/libraries
  - Use raw.githubusercontent.com to fetch specific guides
...
1. Fetch the raw GitHub guide for that framework's setup guide from the Wasp docs.
...
2. Fetch the raw GitHub guide for using ShadCN components with Wasp.
